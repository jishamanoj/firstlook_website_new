  ...
  return (
    <>
      ...
      <div className='font-antonia'>
        <div className="sm:block hidden">
          <div className="flex justify-center">
            <section className="w-[100%] h-screen relative">
              ...
              <div className="relative z-10 mx-auto max-w-screen-xl sm:px-20 py-28 lg:py-36 lg:flex lg:items-center lg:px-16">
                <div className="max-w-2xl text-left sm:mt-40 md:mt-54 lg:mt-36">
                  <motion.h1
                    initial={{ y: "10vw", opacity: 0 }}
                    whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.15 } }}
                    viewport={{ once: true, amount: 0.8 }}
                    className="sm:text-5xl md:text-6xl text-white lg:text-7xl"
                  >
                    Making Connections
                  </motion.h1>
                  <motion.h1
                    ...
                    viewport={{ once: true, amount: 0.8 }}
                    className="sm:text-5xl md:text-6xl text-white lg:text-7xl sm:mt-3"
                  >
                    Effortless
                  </motion.h1>
        ...
        <div className="flex justify-center flex-col sm:items-center lg:mt-16 mt-9 mb-9 lg:mb-16 px-8">
          <motion.h2 initial={{ y: "10vw", opacity: 0 }}
            ...
            Experience effortless <br /> connection’s like never before
          </motion.h2>
          <motion.p initial={{ y: "10vw", opacity: 0 }}
            ...
            Find genuine, ID verified matches in a secure space with versatile relationship goals – whether for marriage, relationship, dating or friendship. Our platform combines social media style interaction, allowing you to find, interact and get to know your match deeply before deciding. <br className="lg:block hidden"/> Experience a unique way to build meaningful connections, all on a single trusted platform.
          </motion.p>
        </div>
        ...
        <div className="sm:hidden block">
          <div className="flex-col lg:flex-row rounded-3xl w-[95%] xl:w-[1150px] mx-auto">
            <div className="flex relative">
              <div className="p-6 sm:p-16">
                <div className="mb-5 sm:hidden block mt-5">
                  <motion.svg initial={{ y: "10vw", opacity: 0 }}
                ...
                <motion.h1 initial={{ y: "10vw", opacity: 0 }}
                  whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                  viewport={{ once: true, amount: 0.8 }} className="text-2xl font-medium">Video Reels <br />
                  bring your profile to life !
                </motion.h1>
                <motion.p initial={{ y: "10vw", opacity: 0 }}
                  whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                  viewport={{ once: true, amount: 0.8 }} className="mt-4 mb-6 sm:mt-10 sm:mb-12 text-sm sm:text-xl xl:text-2xl lg:max-w-[60%] xl:max-w-[38rem] font-light">Showcase your personality like never before. With Video Reels, let your charisma shine through movement, music, and more !</motion.p>
                <motion.div initial={{ y: "10vw", opacity: 0 }}
                  whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                  viewport={{ once: true, amount: 0.8 }} className="flex justify-start sm:mb-0 mb-1.5">
                  <div className="sm:hidden block">
            ...
            <div className="bottom-0 mt-5 mb-12">
              <motion.div
                initial={{ y: "10vw", opacity: 0 }}
                whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.2 } }}
                viewport={{ once: true, amount: 0.8 }}
                className="h-72 sm:h-96 flex justify-center items-center w-full"
              >
                <Image
                  src={reel1}
                  alt="verified-profile"
                  className="object-contain h-72 sm:h-96" />
              </motion.div>
            </div>
          </div>
        </div>
        ...
        <div className="sm:hidden block">
          <div className="flex-col bg-white rounded-3xl w-[95%] mx-auto text-right">
            <div className="flex relative">
              <div className="p-6">
                ...
                <motion.h1 initial={{ y: "10vw", opacity: 0 }}
                  whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                  viewport={{ once: true, amount: 0.8 }} className="text-2xl font-medium">Elevate your connections <br /> with circle’s and proposals!
                </motion.h1>
                <motion.p initial={{ y: "10vw", opacity: 0 }}
                  whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                  viewport={{ once: true, amount: 0.8 }} className="mt-4 mb-6 text-sm font-light">Forge meaningful connections effortlessly. Save your favorites, unlock mutual interest, and take the next step with direct proposals.</motion.p>
                <motion.div initial={{ y: "10vw", opacity: 0 }}
                  whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                  viewport={{ once: true, amount: 0.8 }} className="flex justify-end mb-1.5">
                  <div className="sm:hidden block">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd" d="M12 22.5C14.7848 22.5 17.4555 21.3938 19.4246 19.4246C21.3938 17.4555 22.5 14.7848 22.5 12C22.5 9.21523 21.3938 6.54451 19.4246 4.57538C17.4555 2.60625 14.7848 1.5 12 1.5C9.21523 1.5 6.54451 2.60625 4.57538 4.57538C2.60625 6.54451 1.5 9.21523 1.5 12C1.5 14.7848 2.60625 17.4555 4.57538 19.4246C6.54451 21.3938 9.21523 22.5 12 22.5ZM12 24C15.1826 24 18.2348 22.7357 20.4853 20.4853C22.7357 18.2348 24 15.1826 24 12C24 8.8174 22.7357 5.76516 20.4853 3.51472C18.2348 1.26428 15.1826 0 12 0C8.8174 0 5.76516 1.26428 3.51472 3.51472C1.26428 5.76516 0 8.8174 0 12C0 15.1826 1.26428 18.2348 3.51472 20.4853C5.76516 22.7357 8.8174 24 12 24Z" fill="black" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M6 12C6 12.1989 6.07902 12.3896 6.21967 12.5303C6.36032 12.671 6.55109 12.75 6.75 12.75H15.4395L12.219 15.969C12.1493 16.0387 12.094 16.1215 12.0562 16.2126C12.0185 16.3037 11.9991 16.4014 11.9991 16.5C11.9991 16.5986 12.0185 16.6962 12.0562 16.7873C12.094 16.8785 12.1493 16.9612 12.219 17.031C12.2887 17.1007 12.3715 17.156 12.4626 17.1938C12.5537 17.2315 12.6514 17.2509 12.75 17.2509C12.8486 17.2509 12.9463 17.2315 13.0374 17.1938C13.1285 17.156 13.2113 17.1007 13.281 17.031L17.781 12.531C17.8508 12.4613 17.9063 12.3785 17.9441 12.2874C17.9819 12.1963 18.0013 12.0986 18.0013 12C18.0013 11.9013 17.9819 11.8036 17.9441 11.7125C17.9063 11.6214 17.8508 11.5386 17.781 11.469L13.281 6.96897C13.2113 6.89924 13.1285 6.84392 13.0374 6.80619C12.9463 6.76845 12.8486 6.74902 12.75 6.74902C12.6514 6.74902 12.5537 6.76845 12.4626 6.80619C12.3715 6.84392 12.2887 6.89924 12.219 6.96897C12.1493 7.0387 12.094 7.12149 12.0562 7.2126C12.0185 7.3037 11.9991 7.40136 11.9991 7.49997C11.9991 7.59859 12.0185 7.69624 12.0562 7.78735C12.094 7.87846 12.1493 7.96124 12.219 8.03097L15.4395 11.25H6.75C6.55109 11.25 6.36032 11.329 6.21967 11.4696C6.07902 11.6103 6 11.8011 6 12Z" fill="black" />
            ...
            <div className="bottom-0 mt-12">
              ...
              >
                <Image
                  src={proposal}
                  alt="verified-profile"
                  className="object-contain h-64 mb-24" />
              </motion.div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center">
          <section className="bg-[#1C1C1C] text-white rounded-3xl w-[95%] xl:w-[1150px] lg:block hidden">
            <div className="flex">
              <motion.div initial={{ y: "10vw", opacity: 0 }}
                whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.2 } }}
                viewport={{ once: true, amount: 0.8 }} className="h-full pt-32 pl-12 pb-0.5">
              ...
              <div className="container mx-auto p-14">
                <div className="lg:max-w-3xl xl:max-w-4xl text-right">
                  ...
                  <motion.p initial={{ y: "10vw", opacity: 0 }}
                    whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                    viewport={{ once: true, amount: 0.8 }} className="mt-4 mb-6 sm:mt-6 sm:mb-8 text-sm md:text-base lg:text-lg max-w-md flex ml-auto font-light">Experience seamless communication.
                    From text to images to voice, our chat feature brings conversations to life like never before.</motion.p>
                  <motion.div initial={{ y: "10vw", opacity: 0 }}
                    whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
        ...
        <div className="lg:hidden block bg-[#1C1C1C] text-white rounded-3xl w-[95%] xl:w-[1150px] mx-auto text-right">
          <div className="flex relative">
            <div className="p-6 sm:p-16">
              ...
              <motion.p initial={{ y: "10vw", opacity: 0 }}
                whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
                viewport={{ once: true, amount: 0.8 }} className="mt-4 mb-6 sm:mt-10 sm:mb-12 text-sm sm:text-xl font-light">Experience seamless communication.
                From text to images to voice, our chat feature brings conversations to life like never before.</motion.p>
              <motion.div initial={{ y: "10vw", opacity: 0 }}
                whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
          ...
          <div className="bottom-0 mt-5">
            <motion.div
              ...
              whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.2 } }}
              viewport={{ once: true, amount: 0.8 }}
              className="h-80 sm:h-96 flex justify-center items-center w-full"
            >
              <Image
                src={chat1}
                alt="verified-profile"
                className="object-contain h-80 sm:h-96 -mt-0.5" />
            </motion.div>
          </div>
        </div>
        ...
        <div className="mt-12 sm:mt-16">
          ...
          <div className="">
            <motion.p initial={{ y: "10vw", opacity: 0 }}
              whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
              viewport={{ once: true, amount: 0.8 }} className="mx-auto max-w-[16rem] sm:max-w-none text-center text-sm sm:text-xl xl:text-2xl font-light mt-4 sm:mt-10">
            ...
            <motion.p initial={{ y: "10vw", opacity: 0 }}
              whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.4 } }}
              viewport={{ once: true, amount: 0.8 }} className="mx-auto max-w-xs sm:max-w-none text-center text-[18px] sm:text-2xl md:text-3xl lg:text-4xl mt-4 sm:mt-10">
